...
🎯 Description
Cette application JavaFX permet de convertir des documents XML en JSON et inversement,
en implémentant deux approches complémentaires :
...
L’objectif est de comparer une approche pédagogique bas niveau et une approche plus proche
